...
function DocsAside({
  ...
  return (
    <aside className="hidden md:block w-[200px] flex-shrink-0">
      ...
      >
        <span className={`font-[var(--font-mono)] text-[8px] font-bold tracking-[0.18em] uppercase text-txt-4 px-2 pb-2 select-none`}>
          On this page
        </span>
        {anchors.map((a) => {
            ...
            <a
              ...
              className={`
                ...
                ${isActive
                  ...
                  : "text-txt-3 hover:text-txt-2 hover:bg-bg-2"}
              `}
            >
              {a.label}
            </a>
      ...
      <div className={`flex-shrink-0 bg-bg-1 border-b ${B}`}>
        <div className="px-6 pb-0 pt-7">
          <div className="flex items-baseline gap-2.5 mb-3">
            ...
            <span className="text-[10.5px] text-txt-4 font-[var(--font-mono)]">Agent Office v{process.env.NEXT_PUBLIC_APP_VERSION ?? "dev"}</span>
          </div>
